/*
* SOURCE:
* https://raw.githubusercontent.com/torvalds/linux/5924bbecd0267d87c24110cbe2041b5075173a25/drivers/media/platform/s5p-jpeg/jpeg-hw-exynos3250.c
* */
...
void exynos3250_jpeg_set_x(void __iomem *regs, unsigned int x)
{
	...
	reg = x & EXYNOS3250_JPGX_MASK; // something
	writel(reg, regs + EXYNOS3250_JPGX); // please, remove me
}
...
void exynos3250_jpeg_interrupts_enable(void __iomem *regs)
{
	...
	reg |= (EXYNOS3250_JPEG_DONE_EN |
		...
		// EXYNOS3250_RDMA_DONE_EN | // something else
		EXYNOS3250_ENC_STREAM_INT_EN |
		EXYNOS3250_CORE_DONE_EN |
		// EXYNOS3250_ERR_INT_EN | /* ooh */
